...
function setBio(range) {
  ...
  if (val > 66) { // business
    ...
    bio.innerHTML = `<p>I'm a 24-year-old dude from <em>Italy</em>, 🇪🇺</p>
            ...
            <p>I always loved <em>Photography</em> and <em>Coding</em>. Now I study CS at the University of Bologna and I create websites in my free time. Oh, almost forgot, <em>I shoot on film!</em> (apparently I am legally obliged to say it, it's part of some kind of film shooters code).</p>
